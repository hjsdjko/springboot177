...
public class KuweixinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		kuweixinxi = kuweixinxiService.selectView(new EntityWrapper<KuweixinxiEntity>().eq("id", id));
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<KuweixinxiEntity> wrapper = new EntityWrapper<KuweixinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = kuweixinxiService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<KuweixinxiEntity> ew = new EntityWrapper<KuweixinxiEntity>();
        List<Map<String, Object>> result = kuweixinxiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<KuweixinxiEntity> ew = new EntityWrapper<KuweixinxiEntity>();
        List<Map<String, Object>> result = kuweixinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<KuweixinxiEntity> ew = new EntityWrapper<KuweixinxiEntity>();
        List<Map<String, Object>> result = kuweixinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
